...
type EC2InstanceSpec struct {
	...
	// AMI is the ID of the Amazon Machine Image to use
	// +kubebuilder:validation:Required
	AMI string `json:"ami"`

	// InstanceType is the type of AWS instance (e.g., t2.micro)
	// +kubebuilder:validation:Required
	InstanceType string `json:"instanceType"`

	// Tags is a map of key-value pairs to label the instance in AWS
	// +kubebuilder:validation:Optional
	Tags map[string]string `json:"tags,omitempty"`
	// SubnetID is the specific AWS Subnet to deploy into
	// +kubebuilder:validation:Required
...
type EC2InstanceStatus struct {
	...
	// InstanceID stores the AWS ID of the created instance (e.g., i-12345)
	InstanceID string `json:"instanceID,omitempty"`

	// State represents the current state of the instance (pending, running, terminated)
